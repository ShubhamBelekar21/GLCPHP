...
<div class="" style="margin: 50px; padding:10px;" id="TableOut">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-8">
                <h5 class="text-primary nav-link active">Teaching Staff Faculty</h5>
            </div>

{{--            <div class="col-md-3" style="float: right; margin: 20px;">--}}
{{--                <a class="bttn" href="{{ URL::to('/CreateAlumniDetails') }}"--}}
{{--                   style="color:white;">--}}
{{--                    <b class="">Create</b> </a>--}}
{{--            </div>--}}
        </div>
    ...
    <div class="table-responsive card" style="padding:10px;">
        ...
        width:100%; text-align: center;">
            <thead>
            <tr>
                <th id="pi" scope="col">ProfessorsName</th>
{{--                <th scope="col">ProfessorsName</th>--}}
...
{{--                <th></th>--}}
            ...
            <tbody>
            @foreach($TeachingStaffFacultyList as $item)
                <tr>
                    <td id="pi" scope="row">{{ $item->ProfessorsName }}</td>
...
{{--                    <td>--}}
{{--                        <a class="text-primary" href="{{ URL::to('EditAlumniDetails',array($item->SrNo))}}">Edit</a>--}}
{{--                        <a class="text-primary" href="{{ URL::to('ViewAlumniDetails',array($item->SrNo))}}">| View |</a>--}}
