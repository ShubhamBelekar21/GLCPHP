...
<div class="" style="margin: 50px; padding:10px;" id="TableOut">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-8">
                <h5 class="text-primary nav-link active">PDF Master Details</h5>
            </div>
...
{{--            </div>--}}
    ...
    <div class="table-responsive card" style="padding:10px;">
        ...
        width:100%; text-align: center;">
            ...
            <tbody>
            @foreach($PdfMasterList as $item)
                <tr>
                    <td id="pi" scope="row">{{ $item->Title }}</td>
                    <td>{{ $item->PDF}}</td>
                    <td>
                        <a class="text-primary" href="{{ URL::to('EditPdfMaster',array($item->SrNo))}}">Edit</a>
                        <a class="text-primary" href="{{ URL::to('ViewPdfMaster',array($item->SrNo))}}">| View </a>
