    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Enter Infrastructure Details</h2>
            </div>

        </div>
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostCreateInfrastructure'),'method' => 'post' ))}}
        ...
        <label class="" for="name">Photo 1 <span class="required" style="color: red;">*</span></label>
        <div class="">
        ...
        {{--        pic 1--}}
        <label class="" for="name">Photo 2 <span class="required" style="color: red;">*</span></label>
        <div class="">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#submit').click(function () {
            ...
            if (files.length > 0 && Photo2.length > 0) {
                var fd = new FormData();
                ...
                // AJAX request
                $.ajax({
                    url: "{{route('PostCreateInfrastructure')}}",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
