    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Enter New Law Review Details</h2>
            </div>

        </div>
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostCreateNewLawReview'),'method' => 'post' ))}}
    ...
    $(document).ready(function () {
        ...
        $('#submit').click(function () {
            ...
            if (files.length > 0) {
                ...
                // AJAX request
                $.ajax({
                    url: "{{route('PostCreateNewLawReview')}}",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
