    ...
    <div class="mwb-form-main-container" style="min-height:auto; width: auto">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Edit New Law Review</h2>
            </div>

        </div>

        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditNewLawReview'),'method' => 'post'))}}
        ...
        <div class="mwb-form-group" style="margin-left:230px; margin-top: 20px;">
            <div class="" style="margin-top: 0.8%;">
                @if ($PDF == null || $PDF == "")
                    <iframe id="PDF" style="width: 200px; height: 180px; border: solid;" src=""></iframe>
                @else
                    <iframe id="PDF" style="width: 300px; height: 200px; border: solid;"src="{{ asset($PDF) }}"></iframe>
                @endif
            </div>
        </div>
    ...
    $(document).ready(function () {
        ...
        $('#btnsubmitid').click(function () {
            ...
            if (files != null && files != "" || Title1 != null && Title1 != ""||
                ...
                // AJAX request
                $.ajax({
                    url: "{{route('PostEditNewLawReview')}}",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
