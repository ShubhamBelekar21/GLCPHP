...
<div class="" style="margin: 50px; padding:10px;" id="TableOut">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-8">
                <h5 class="text-primary nav-link active">Tender Details</h5>
            </div>
    ...
    <div class="table-responsive card" style="padding:10px;">
        ...
        width:100%; text-align: center;">
            <thead>
            <tr>
                <th id="pi" scope="col">TenderNo</th>
                <th scope="col">Description</th>
                <th scope="col">TenderDate</th>
                <th scope="col">PDF</th>
            ...
            @foreach($TendersList as $item)
                <tr>
                    ...
                    <td>{{ $item->IsActive}}</td>
                    <td>
                        <a class="text-primary" href="{{ URL::to('EditTender',array($item->SrNo))}}">Edit</a>
                        <a class="text-primary" href="{{ URL::to('ViewTender',array($item->SrNo))}}">| View |</a>
