    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Edit Tender Details</h2>
            </div>

        </div>

        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditTender'),'method' => 'post'))}}
        <input type="hidden" name="SrNo" id="SrNo" value="{{$SrNo}}">

        <div class="mwb-form-group">
            <label for="name" class="">Enter Tender No</label>
            <input type="text" class="mwb-form-control" value="{{$TenderNo}}" id="TenderNo" name="TenderNo"
                   >
        </div>
        <div class="mwb-form-group">
        ...
        <div class="mwb-form-group">
            ...
            <input type="date" class="mwb-form-control" value="{{$TenderDate}}" id="TenderDate" name="TenderDate"
                   >
        </div>
        ...
        <div class="mwb-form-group" style="margin-left:230px; margin-top: 20px;">
            <div class="" style="margin-top: 0.8%;">
                ...
                @else
                    <iframe id="file" style="width: 300px; height: 200px; border: solid;"src="{{ asset($PDF) }}"></iframe>
                @endif
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btnsubmitid').click(function () {
            ...
            if (files != null && files != "" || TenderNo1 != null && TenderNo1 != "" || Description1 != null && Description1 != "" ||
                TenderDate1 != null && TenderDate1 != ""
            ) {
                var fd = new FormData();
