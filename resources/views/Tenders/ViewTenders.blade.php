    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">View Tender Details Here</h2>
            </div>
        </div>
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditGalleryDetails'),'method' => 'post'))}}
        <input type="hidden" name="SrNo" id="SrNo" value="{{$SrNo}}">

        <div class="mwb-form-group">
            <label for="name" class="">Tender No :</label>
        ...
        <div class="mwb-form-group">
            <label for="name" class="">Tender Date :</label>
            <input type="text" class="mwb-form-control" value="{{$TenderDate}}" id="TenderDate" name="TenderDate"
                   required readonly>
        </div>
        ...
        <div class="mwb-form-group" style="margin-left:230px; margin-top: 20px;">
            <div class="" style="margin-top: 0.8%;">
                ...
                @else
                    <iframe id="PDF1" style="width: 370px; height: 250px; border: solid;"src="{{ asset($PDF) }}"></iframe>
                @endif
            </div>
        </div>
