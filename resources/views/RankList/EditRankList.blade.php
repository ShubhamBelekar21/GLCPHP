    ...
    <div class="mwb-form-main-container" style="min-height:auto; width: auto">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Edit Rank List Details</h2>
            </div>

        </div>

        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditRankList'),'method' => 'post'))}}
        <input type="hidden" name="SrNo" id="SrNo" value="{{$SrNo}}">

        <div class="mwb-form-group">
            <label for="name" class="">Program</label>
            <input type="text" class="mwb-form-control" value="{{$ProgramName}}" id="ProgramYear" name="ProgramYear"
                   required readonly>
        </div>
        <div class="mwb-form-group">
            <label for="name" class="">Year</label>
            <input type="text" class="mwb-form-control" value="{{$Year}}" id="Year" name="Year"
                   required readonly>
        </div>
        <div class="mwb-form-group">
            <label for="name" class="">Rank</label>
            <input type="text" class="mwb-form-control" value="{{$Rank}}" id="Rank" name="Rank"
                   required readonly>
        </div>

        <div class="mwb-form-group">
            <label for="name" class="">Name</label>
            <input type="text" class="mwb-form-control" value="{{$Name}}" id="Name" name="Name"
                   required >
        </div>
...
<script type="text/javascript">
    ...
    {{--                    debugger;--}}
    {{--                    window.location.href = '/PdfMasterIndex';--}}
    {{--                }--}}
    {{--            });--}}
    {{--        }--}}
    {{--    });--}}
