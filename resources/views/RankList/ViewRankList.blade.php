    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">View Ranking Details Here</h2>
            </div>
        </div>
        ...
        <div class="mwb-form-group">
            <label for="name" class="">Program Name:</label>
            <input type="text" class="mwb-form-control" value="{{$ProgramName}}" id="ProgramName" name="ProgramName"
                   required readonly>
        </div>
        <div class="mwb-form-group">
