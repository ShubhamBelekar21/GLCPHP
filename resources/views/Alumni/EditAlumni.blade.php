...
<div class="mwb-form-main-wrapper">
    <div class="mwb-form-main-container">
        ...
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditAlumni'),'method' => 'post'))}}
        ...
        <div class="mwb-form-group">
            <label for="name" class="">Enter Alumni Name</label>
            <input type="text" class="mwb-form-control" value="{{$AlumniName}}" id="AlumniName" name="AlumniName"
                   >
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btnsubmitid').click(function () {
            ...
            if (files != null && files != "" || Title1 != null && Title1 != "" || AlumniName1 != null && AlumniName1 != "" ||
