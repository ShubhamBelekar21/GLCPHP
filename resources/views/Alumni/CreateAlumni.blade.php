    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Enter Alumni Details</h2>
            </div>

        </div>
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostCreateAlumni'),'method' => 'post' ))}}
        ...
        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="AlumniName" name="AlumniName" required>
            <label for="name" class="mwb-form-text-label">Enter Alumni Name</label>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#submit').click(function () {
            ...
            var AlumniName1 = $("#AlumniName").val();
            ...
            if (files.length > 0) {
                ...
                fd.append('AlumniName', AlumniName1);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        window.location.href = '/AlumniIndex2';
                    },
...
{{--    $.ajax({--}}
{{--        url: "{{URL::to('/GetEmployeeListForPensioner')}}",--}}
{{--        type: 'GET',--}}
{{--        datatype: "json",--}}
{{--        traditional: true,--}}
...
{{--            $('#Title').selectize();--}}
{{--            $('#Title').selectize()[0].selectize.destroy();--}}
{{--            $('#Title').empty();--}}
{{--            $('#Title').prop('disabled', false);--}}
{{--            $.each(JSON.parse(data), function (i, item) {--}}
{{--                $('#Title').append('<option value="' + item.EmployeeId + '">' + item.EmployeeName + '</option>');--}}
{{--            });--}}

{{--            $select =    $('#Title').selectize({ placeholder: '--SELECT--' });--}}
