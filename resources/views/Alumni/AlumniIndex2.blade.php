...
<div class="" style="margin: 50px; padding:10px;" id="TableOut">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-8">
                <h5 class="text-primary nav-link active">Alumni Details</h5>
            </div>

            <div class="col-md-3" style="float: right; margin: 20px;">
                <a class="bttn" href="{{ URL::to('/CreateAlumni') }}"
                   style="color:white;">
                    <b class="">Create Title</b> </a>
            </div>
        </div>
    </div>
        ...
        width:100%; text-align: center;">
            ...
            @foreach($AlumniList as $item)
                <tr>
                    ...
                    <td><img src="{{$item->Photo}}" width="100" height="100">
                    <td>{{ $item->IsActive}}</td>
                    <td>
                        <a class="text-primary" href="{{ URL::to('AddAlumni',array($item->SrNo))}}">Add Alumni |</a>
                        <a class="text-primary" href="{{ URL::to('EditAlumni',array($item->SrNo))}}">Edit</a>
                        <a class="text-primary" href="{{ URL::to('ViewAlumni',array($item->SrNo))}}">| View |</a>
...
@section('selectize-script')
    ...
    <script type="text/javascript">
        function changestatus(SrNo, IsActive) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    url: "{{URL::to('/AlumniStatusChange2')}}/" + SrNo + "/" + IsActive,
                    type: 'GET',
                    datatype: "json",
                    traditional: true,
