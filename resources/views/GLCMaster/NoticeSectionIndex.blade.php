...
{{--    <div class="list-group-item">--}}
    <div class="">
        <div class="row">
            ...
            <div class="col-md-3" style="float: right; margin: 20px;">
                <a class="bttn" href="{{ URL::to('/CreateNoticeDetails') }}"
                   style="color:gray;">
                    <b class="">Create</b> </a>
            </div>
        </div>
    ...
    <div class="table-responsive card" style="padding:10px;">
        ...
        width:100%; text-align: center;">
            ...
            <tbody>
            @foreach($NoticeSectionList as $item)
                <tr>
                    ...
                    <td>{{ $item->PDFUrl }}</td>
                    <td>
                        <a class="text-primary" href="{{ URL::to('EditNoticeDetails',array($item->id))}}">Edit</a>
                        <a class="text-primary" href="{{ URL::to('ViewNoticeDetails',array($item->id))}}">| View |</a>
...
@section('selectize-script')
    ...
    <script type="text/javascript">
        function changestatus(id, IsActive) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    url: "{{URL::to('/NoticeStatusChange')}}/" + id + "/" + IsActive,
                    type: 'GET',
                    datatype: "json",
                    traditional: true,
