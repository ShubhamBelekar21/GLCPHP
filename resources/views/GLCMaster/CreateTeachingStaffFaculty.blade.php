    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Enter Teaching Staff Faculty Details</h2>
            </div>
        ...
        <div class="mwb-form-group">
            ...
            <label for="name" class="mwb-form-text-label">Enter TeachingExperience</label>
        </div>
    ...
    $(document).ready(function () {
        ...
        $('#submit').click(function () {
            ...
            if (files.length > 0) {
                ...
                // AJAX request
                $.ajax({
                    url: "{{route('PostCreateTeachingStaffFaculty')}}",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
