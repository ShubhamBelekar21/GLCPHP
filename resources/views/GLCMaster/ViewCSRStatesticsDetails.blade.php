...
<div class="mwb-form-main-wrapper">
    <div class="mwb-form-main-container">
        ...
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditCSRStatesticsDetails'),'method' => 'post'))}}
        <input type="hidden" id="Id" name="id" value="{{$id}}">

        <div class="mwb-form-group">
            <label for="name" class="">Enter Categories</label>
            <input type="text" class="mwb-form-control" value="{{$Categories}}" id="Category" name="Category"
                   required readonly>
        </div>

        <div class="mwb-form-group">
            <label for="name" class="">Enter Headers</label>
            <input type="text" class="mwb-form-control" value="{{$Headers}}" id="Headers" name="Headers"
                   required readonly>
        </div>

        <div class="mwb-form-group">
            <label for="name" class="">Enter Values</label>
            <input type="text" class="mwb-form-control" value="{{$Valuesss}}" id="Values" name="Values" required readonly>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#submit').click(function () {
            ...
            // AJAX request
            $.ajax({
                url: "{{route('PostEditCSRStatesticsDetails')}}",
                method: 'post',
                data: formModel,
                contentType: false,
                processData: false,
