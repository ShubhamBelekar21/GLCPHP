...
<div class="" style="margin: 50px; padding:10px;" id="TableOut">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-8">
                <h5 class="text-primary nav-link active">Non Teaching Staff Details</h5>
            </div>

            <div class="col-md-3" style="float: right; margin: 20px;">
                <a class="bttn" href="{{ URL::to('/CreateNonTeachingStaff') }}"
                   style="color:white;">
                    <b class="">Create</b> </a>
            </div>
        </div>
...
{{--                <th></th>--}}
            ...
            <tbody>
            @foreach($NonTeachingStaffList as $item)
                <tr>
...
{{--                    <td><img src={{$item->Photo}} height="100" width="100"></td>--}}
                    <td>
                        <a class="text-primary" href="{{ URL::to('EditNonTeachingStaff',array($item->SrNo))}}">Edit</a>
                        <a class="text-primary" href="{{ URL::to('ViewNonTeachingStaff',array($item->SrNo))}}">| View |</a>
...
@section('selectize-script')
    ...
    <script type="text/javascript">
        function changestatus(SrNo, IsActive) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    url: "{{URL::to('/NonTeachingStaffStatusChange')}}/" + SrNo + "/" + IsActive,
                    type: 'GET',
                    datatype: "json",
                    traditional: true,
