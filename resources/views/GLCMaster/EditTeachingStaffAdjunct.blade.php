...
<div class="mwb-form-main-wrapper">
    <div class="mwb-form-main-container">
        ...
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditTeachingStaffAdjunct'),'method' => 'post'))}}
        ...
        <div class="mwb-form-group">
            <label for="name" class="">Enter Teaching Experience</label>
            <input type="text" class="mwb-form-control" value="{{$TeachingExperience}}" id="TeachingExperience" name="TeachingExperience"
                   >
        </div>
        <div class="mwb-form-group">
            <label for="name" class="">Enter Professional Experience</label>
            <input type="text" class="mwb-form-control" value="{{$ProfessionalExperience}}" id="ProfessionalExperience" name="ProfessionalExperience"
                   >
        </div>
        <div class="mwb-form-group">
            <label for="name" class="">Enter Research Publication</label>
            <input type="text" class="mwb-form-control" value="{{$ResearchPublication}}" id="ResearchPublication" name="ResearchPublication"
                   >
        </div>
    ...
    $(document).ready(function () {
        ...
        $('#btnsubmitid').click(function () {
            ...
            if (files != null && files != "" || ProfessorsName1 != null && ProfessorsName1 != "" || Subject1 != null && Subject1 != "" ||
                Qualification1 != null && Qualification1 != "" || TeachingExperience1 != null && TeachingExperience1 != "" || ProfessionalExperience1 != null && ProfessionalExperience1 != ""
            || ResearchPublication1 != null && ResearchPublication1 != "" ) {
                var fd = new FormData();
                ...
                // AJAX request
                $.ajax({
                    url: "{{route('PostEditTeachingStaffAdjunct')}}",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
