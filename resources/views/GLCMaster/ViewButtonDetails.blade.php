...
<div class="mwb-form-main-wrapper">
    <div class="mwb-form-main-container">
        ...
        <div class="mwb-form-group">
            ...
            <input type="text" class="mwb-form-control" value="{{$DisplayText}}" readonly id="DisplayText" name="DisplayText"
                   required readonly>
        </div>

        <div class="mwb-form-group">
            <label for="name" class="">Enter File Path</label>
            <input type="text" class="mwb-form-control" value="{{$PdfUrl}}" readonly id="FilePath" name="FilePath" required >
        </div>

{{--        <div class="mwb-form-group">--}}
{{--            <label for="name" class="">Enter Url</label>--}}
{{--            <input type="text" class="mwb-form-control" value="{{$Url}}" id="Url" readonly name="Url" required >--}}
{{--        </div>--}}
