    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin:10px; text-align: center;">
                <h2 class="text-primary">Create Marquee Here</h2>
            </div>
        ...
        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="Text" name="DisplayText" required>
            <label for="name" class="mwb-form-text-label">Enter Text</label>
        </div>
    ...
    $(document).ready(function () {
            ...
            $('#btnsubmitid').click(function () {
                    ...
                    if (document.getElementById('chkSelect1').checked) {
                        ...
                        $.ajax({
                            url: "{{route('PostMarqueeDetailsUrl')}}",
                            method: 'post',
                            data: fd,
                            contentType: false,
                            processData: false,
