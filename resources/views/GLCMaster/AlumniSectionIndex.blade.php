...
<div class="" style="margin: 50px; padding:10px;" id="TableOut">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-8">
                <h5 class="text-primary nav-link active">Alumni Section Details</h5>
            </div>
    ...
    <div class="table-responsive card" style="padding:10px;">
        ...
        width:100%; text-align: center;">
            ...
            <tbody>
            @foreach($AlumniSectionList as $item)
                <tr>
                    ...
                    <td>{{ $item->ImageUrl }}</td>
                    <td>
                        <a class="text-primary" href="{{ URL::to('EditAlumniDetails',array($item->id))}}">Edit</a>
                        <a class="text-primary" href="{{ URL::to('ViewAlumniDetails',array($item->id))}}">| View |</a>
