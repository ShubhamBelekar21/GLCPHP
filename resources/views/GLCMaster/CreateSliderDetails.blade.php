    ...
    <div class="mwb-form-main-container">
        <div class="row"  >
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Create Slider Section Here</h2>
            </div>

        </div>
        <!-- Response message -->
        <div class="alert displaynone" id="responseMsg"></div>
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostSliderDetails'),'method' => 'post' ))}}
