    ...
    <div class="mwb-form-main-container">
        <div class="row"  >
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">View Notice Here</h2>
            </div>

        </div>

        <div class="" style="padding-top:15px; margin-left: 600px;">
        ...
        <form>
            ...
            <div class="mwb-form-group">
                ...
                <input type="text" class="mwb-form-control" value="{{$Title}}" readonly id="DisplayText" name="DisplayText"
                       required >
            </div>

            <div class="mwb-form-group">
                <label for="name" class="">Description</label>
                <input type="text" class="mwb-form-control" value="{{$Description}}" readonly
                       id="FilePath" name="FilePath" required >
            </div>

            <div class="mwb-form-group">
                <label for="name" class=""> Short Description</label>
                <input type="text" class="mwb-form-control" value="{{$ShortDescription}}"
                       id="Url" readonly name="Url" required >
            </div>

{{--            <div class="mwb-form-group">--}}
{{--                <label for="name" class="">Pdf</label>--}}
{{--                --}}{{--<input type="text" class="mwb-form-control" value="{{$PDFUrl}}"--}}
...
{{--            </div>--}}
            ...
            <div class="mwb-form-group" style="margin-right:230px; margin-top: 20px;">
                <label for="name" class=""> PDF</label>
