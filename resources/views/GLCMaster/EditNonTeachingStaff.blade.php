...
<div class="mwb-form-main-wrapper">
    <div class="mwb-form-main-container">
        ...
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditNonTeachingStaff'),'method' => 'post'))}}
        ...
        <div class="mwb-form-group">
            <label for="name" class="">Enter Designation</label>
            <input type="text" class="mwb-form-control" value="{{$Designation}}" id="Designation" name="Designation"
                   >
        </div>

{{--        <div class="mwb-form-group">--}}
{{--            <label for="name" class="">Enter Department</label>--}}
{{--            <input type="text" class="mwb-form-control" value="{{$Department}}" id="Department" name="Department"--}}
{{--                   required>--}}
{{--        </div>--}}
...
<script type="text/javascript">
    ...
    {{--        if (files != null && files != "" || ProfessorsName1 != null && ProfessorsName1 != "" || Designation1 != null && Designation1 != "" ||--}}
    {{--            Department1 != null && Department1 != ""--}}
    {{--        ) {--}}
    {{--            var fd = new FormData();--}}
    ...
    {{--            // AJAX request--}}
    {{--            $.ajax({--}}
    {{--                url: "{{route('PostEditNonTeachingStaff')}}",--}}
    {{--                method: 'post',--}}
    {{--                data: fd,--}}
    {{--                contentType: false,--}}
    {{--                processData: false,--}}
