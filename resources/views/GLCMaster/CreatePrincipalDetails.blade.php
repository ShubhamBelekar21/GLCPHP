    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Create Principal Section Here</h2>
            </div>
        ...
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostPrincipalDetails'),'method' => 'post' ))}}
    ...
    $(document).ready(function () {
        ...
        $('#submit').click(function () {
            ...
            if (files.length > 0) {
                ...
                // AJAX request
                $.ajax({
                    url: "{{route('PostPrincipalDetails')}}",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
