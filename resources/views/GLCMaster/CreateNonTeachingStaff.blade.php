    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Enter Non Teaching Staff Details</h2>
            </div>

        </div>
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostCreateNonTeachingStaff'),'method' => 'post' ))}}
        ...
        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="Designation" name="Designation" required>
            <label for="name" class="mwb-form-text-label">Enter Designation</label>
        </div>

{{--        <div class="mwb-form-group">--}}
{{--            <input type="text" class="mwb-form-control" value="" id="Department" name="Department" required>--}}
{{--            <label for="name" class="mwb-form-text-label">Enter Department</label>--}}
{{--        </div>--}}
...
<script type="text/javascript">
    ...
    {{--            fd.append('Designation', Designation1);--}}
    {{--            fd.append('Department', Department1);--}}
    ...
    {{--            // AJAX request--}}
    {{--            $.ajax({--}}
    {{--                url: "{{route('PostCreateNonTeachingStaff')}}",--}}
    {{--                method: 'post',--}}
    {{--                data: fd,--}}
    {{--                contentType: false,--}}
    {{--                processData: false,--}}
    ...
    {{--                    }--}}
    {{--                    window.location.href = '/NonTeachingStaffIndex2';--}}
    {{--                },--}}
