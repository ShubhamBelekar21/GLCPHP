...
{{--    <div class="list-group-item">--}}
    <div class="">
        <div class="row">
            <div class="col-md-4">
{{--                <h5 class="text-primary nav-link active">Event Details</h5>--}}
                <h5 class="">Event Details</h5>
            </div>
            <div class="col-md-3" style="float: right; margin: 20px;">
                <a class="bttn" href="{{ URL::to('/CreateEventDetails') }}"
                   style="color:gray;">
{{--                    <b class="text-primary border-red-light">Create</b> </a>--}}
    ...
    <div class="table-responsive card" style="padding:10px;">
        ...
        width:100%; text-align: center;">
            ...
            <tbody>
            @foreach($EventSectionList as $item)
                <tr>
                    ...
                    <td>{{ $item->PDFUrl }}</td>
                    <td>
                        <a class="text-primary" href="{{ URL::to('EditEventsDetails',array($item->id))}}">Edit</a>
                        <a class="text-primary" href="{{ URL::to('ViewEventsDetails',array($item->id))}}">| View |</a>
...
@section('selectize-script')
            ...
            $('#dt').DataTable({
                ...
                initComplete: function () {
                    this.api().columns().every(function () {
                        ...
                        column.data1().unique().sort().each(function (d, j) {
                            var ce = d;
                            if (ce.includes("<a")) {
                            } else {
    ...
    <script type="text/javascript">
        function changestatus(id, IsActive) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    url: "{{URL::to('/EventStatusChange')}}/" + id + "/" + IsActive,
                    type: 'GET',
                    datatype: "json",
                    traditional: true,
