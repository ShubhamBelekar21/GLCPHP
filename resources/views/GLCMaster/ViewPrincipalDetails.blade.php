    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">View Details Here</h2>
            </div>
        </div>
        <form>
            ...
            <div class="mwb-form-group">
                ...
                <input type="text" class="mwb-form-control" value="{{$Title}}" readonly id="DisplayText"
                       name="DisplayText"
                       required>
            </div>
...
{{--                <input type="text" class="mwb-form-control" value="{{$Url}}"--}}
