...
<div class="mwb-form-main-wrapper">
    <div class="mwb-form-main-container">
        ...
        <div class="mwb-form-group">
            <label for="name" class="">Enter Display Text</label>
            <input type="text" class="mwb-form-control" value="{{$DisplayText}}" id="DisplayText" name="DisplayText"
                   >
        </div>

{{--        <div class="mwb-form-group">--}}
{{--            <label for="name" class="">Current Path</label>--}}
{{--            <input type="text" class="mwb-form-control" value="{{$PdfUrl}}" id="FilePath" name="FilePath" required readonly>--}}
{{--        </div>--}}
...
{{--        <div class="mwb-form-group" id="EditEnterurl" >--}}
{{--            <label for="name" class="mwb-form-text-label" >File Path (URL) Here</label>--}}
{{--            <input type="url" class="mwb-form-control" id="EditEnterurl2" pattern="https://.*" name="Enterurl" >--}}
{{--        </div>--}}

{{--        <div>--}}
{{--            <label style="text-align: center; padding-left: 360px" >OR</label>--}}
{{--        </div>--}}

{{--        <div class="mwb-form-group" id="Editpdf">--}}
{{--            <label for="name" class="">PDF</label>--}}
{{--            <input type='file' id="Editpdf2" name='file' class="form-control">--}}
...
{{--        <div class="mwb-form-group">--}}
{{--            <label for="name" class="">Enter Url</label>--}}
{{--            <input type="text" class="mwb-form-control" value="{{$Url}}" id="Url" name="Url" required>--}}
{{--        </div>--}}
...
{{--        </div>--}}
        ...
        <div class="" style="padding-top:15px; text-align: center;">
            <input type="button" value="Submit" class="btn btn-success" id="btnsubmitid"/>
...
{{--                    <iframe id="file" style="width: 200px; height: 180px; " src=""/>--}}
{{--                @else--}}
{{--                    <iframe id="file" style="width: 500px; height: 380px; "--}}
{{--                            src="{{ asset($PdfUrl) }}"/>--}}
{{--                @endif--}}
{{--            </div>--}}
    ...
    $(document).ready(function () {
            ...
            $('#btnsubmitid').click(function () {
                    ...
                    if (document.getElementById('chkSelect1').checked) {
                        ...
                        var id = $("#Id").val();
                        var DisplayText1 = $("#DisplayText").val();
                        ...
                        fd.append('id', id);
                        fd.append('DisplayText', DisplayText1);
                        ...
                        $.ajax({
                            url: "{{route('PostEditButtonsDetailsForUrl')}}",
                            method: 'post',
                            data: fd,
                            contentType: false,
                            processData: false,
                            ...
                            success: function (response) {
                                ...
                                window.location.href = '/FourButtonIndex';
                            },
                        ...
                        if (files.length > 0) {
                            ...
                            $.ajax({
                                url: "{{route('PostEditButtonDetails')}}",
                                method: 'post',
                                data: fd,
                                contentType: false,
                                processData: false,
