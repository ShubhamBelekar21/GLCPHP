...
@section('page-css')
    ...
    <style>
        ...
        .bttn {
            font-size: 20px;
            padding: 10px 20px;
            background-image: linear-gradient(315deg, #E7902F 0%, #E7902F 74%);
            color: red;
            line-height: 50px;
            border: none;
            margin-top: -50px;
...
<div class="" style="margin: 50px; padding:10px;" id="TableOut">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-8">
                <h5 class="text-primary nav-link active">CSR Statistic Details</h5>
            </div>

            <div class="col-md-3" style="float: right; margin: 20px;">
                <a class="bttn" href="{{ URL::to('/CreateCSRStatesticsForMember') }}"
                   style="color:gray;">
    ...
    <div class="table-responsive card" style="padding:10px;">
        ...
        width:100%; text-align: center;">
            ...
            <tbody>
            @foreach($CSRStatesticsForMemberList as $item)
                <tr>
                    ...
                    <td>{{ $item->Valuesss }}</td>
                    <td>
                        <a class="text-primary" href="{{ URL::to('EditCSRStatesticsDetails',array($item->id))}}">Edit</a>
                        <a class="text-primary" href="{{ URL::to('ViewCSRStatesticsDetails',array($item->id))}}">| View </a>
                    </td>
                </tr>
            @endforeach
            </tbody>
