...
<div class="" style="margin: 50px; padding:10px;" id="TableOut">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-8">
                <h5 class="text-primary nav-link active">Teaching Staff Faculty Details</h5>
            </div>

            <div class="col-md-3" style="float: right; margin: 20px;">
                <a class="bttn" href="{{ URL::to('/CreateTeachingStaffFaculty') }}"
                   style="color:white;">
                    <b class="">Create</b> </a>
            </div>
        </div>
        ...
        width:100%; text-align: center;">
            ...
            @foreach($TeachingStaffFacultyList as $item)
                <tr>
                    ...
                    <td>
                        <a class="text-primary" href="{{ URL::to('EditTeachingStaffFaculty',array($item->SrNo))}}">Edit</a>
                        <a class="text-primary" href="{{ URL::to('ViewTeachingStaffFaculty',array($item->SrNo))}}">| View |</a>
...
@section('selectize-script')
    ...
    <script type="text/javascript">
        function changestatus(SrNo, IsActive) {
            ...
            if (confirm(msg)) {
                $.ajax({
                    url: "{{URL::to('/TeachingStaffFacultyStatusChange')}}/" + SrNo + "/" + IsActive,
                    type: 'GET',
                    datatype: "json",
                    traditional: true,
