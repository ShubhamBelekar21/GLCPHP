    ...
    <div class="mwb-form-main-container">
        <div class="row"  >
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">View Events Here</h2>
            </div>
            ...
            <div class="mwb-form-group" style="margin-left:10%; margin-top: 20px;">
                <div class="" style="margin-top: 0.8%;">
                    @if ($PDFUrl == null || $PDFUrl == "")
                        <iframe id="file" style="width: 200px; height: 180px; border: solid;" src=""></iframe>
                    @else
                        <iframe id="file" style="width: 600px; height: 400px; border: solid;"src="{{ asset($PDFUrl) }}"></iframe>
                    @endif
                </div>
            </div>
