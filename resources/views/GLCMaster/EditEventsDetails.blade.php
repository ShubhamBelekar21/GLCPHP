    ...
    <div class="mwb-form-main-container">
        <div class="row"  >
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Edit Events Here</h2>
            </div>

        </div>
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditEventsDetails'),'method' => 'post', 'files' => true))}}
        ...
        {{--<div class="mwb-form-group">
            <label for="name" class="">Enter PDF Url</label>
            <input type="text" class="mwb-form-control" value="{{$PDFUrl}}" id="Url" name="Url" required>
        </div>--}}
