...
<div class="mwb-form-main-wrapper">
    <div class="mwb-form-main-container">
        ...
        <div class="mwb-form-group">
            ...
            <input type="text" class="mwb-form-control" readonly value="{{$Title}}" id="Title" name="Title"
                   required>
        </div>

        <div class="mwb-form-group">
            <label for="name" class="">Enter Description</label>
            <input type="text" class="mwb-form-control" readonly value="{{$Description}}" id="Description" name="Description"
                   required>
        </div>
