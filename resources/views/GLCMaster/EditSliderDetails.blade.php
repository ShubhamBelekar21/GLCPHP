...
<div class="mwb-form-main-wrapper">
    <div class="mwb-form-main-container">
        ...
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEditSliderDetails'),'method' => 'post'))}}
        ...
        <div style="margin-left:230px;">
            <div class="" style="margin:20px;">
                @if ($ImageUrl == null || $ImageUrl == "")
                    <img id="file1" style="width: 200px; height: 180px; border: solid;" src=""/>
                @else
                    <img id="file1" style="width: 200px; height: 180px; border: solid;"
                         src="{{ asset($ImageUrl) }}"/>
                @endif
            </div>
        </div>
...
{{--            <input type="text" class="mwb-form-control" value="{{$ImageUrl}}" id="Url" name="Url" required>--}}
{{--        </div>--}}
    ...
    $(document).ready(function () {
        ...
        $('#submit').click(function () {
            ...
            if (files != null && files != "" || Title1 != null && Title1 != "") {
                ...
                // AJAX request
                $.ajax({
                    url: "{{route('PostEditSliderDetails')}}",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
