    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Enter Teaching Staff Adjunct Details</h2>
            </div>
        ...
        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="ProfessorsName" name="ProfessorsName" required>
            <label for="name" class="mwb-form-text-label">Enter ProfessorsName</label>
        </div>
        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="Subject" name="Subject" required>
            <label for="name" class="mwb-form-text-label">Enter Subject</label>
        </div>

        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="Qualification" name="Qualification" required>
            <label for="name" class="mwb-form-text-label">Enter Qualification</label>
        </div>
        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="TeachingExperience" name="TeachingExperience" required>
            <label for="name" class="mwb-form-text-label">Enter Teaching Experience</label>
        </div>
        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="ProfessionalExperience" name="ProfessionalExperience" required>
            <label for="name" class="mwb-form-text-label">Enter Professional Experience</label>
        </div>
        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="ResearchPublication" name="ResearchPublication" required>
            <label for="name" class="mwb-form-text-label">Enter Research/Publication</label>
        </div>

        {{--        Upload Image--}}

        <label class="" for="name">File <span class="required" style="color: red;">*</span></label>
        <div class="">
        ...
        {{--        <div class="mwb-form-group">--}}
        {{--            <input type="text" class="mwb-form-control" id="Url" name="Url" required>--}}
        {{--            <label for="text" class="mwb-form-text-label">Enter Image Url</label>--}}
        {{--        </div>--}}
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#submit').click(function () {
            ...
            var ProfessionalExperience1 = $("#ProfessionalExperience").val();
            var ResearchPublication1 = $("#ResearchPublication").val();
            ...
            if (files.length > 0) {
                ...
                fd.append('ProfessionalExperience', ProfessionalExperience1);
                fd.append('ResearchPublication', ResearchPublication1);
                ...
                // AJAX request
                $.ajax({
                    url: "{{route('PostCreateTeachingStaffAdjunct')}}",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
                    ...
                    success: function (response) {
                        ...
                        window.location.href = '/TeachingStaffAdjunctIndex2';
                    },
