    ...
    <div class="mwb-form-main-container">
        <div class="row">
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Enter Course Details</h2>
            </div>
        ...
        <div class="mwb-form-group">
            <input type="text" class="mwb-form-control" value="" id="CourseName" name="CourseName" required>
            <label for="name" class="mwb-form-text-label">Enter Course Name</label>
        </div>
        <div class="mwb-form-group">
        ...
        <label class="" for="name">Upload Notice <span class="required" style="color: red;">*</span></label>
        <div class="">
        ...
        {{--        Upload PDF 2--}}
        <label class="" for="name">Upload Prospectus <span class="required" style="color: red;">*</span></label>
        <div class="">
            ...
            if (files.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        window.location.href = '/CoursesIndex2';
                    },
