    ...
    <div class="mwb-form-main-container">
        <div class="row"  >
            <div class="" style="margin: 10px; text-align: center;">
                <h2 class="text-primary">Create Events Here</h2>
            </div>

        </div>
        {{Form::open(array('action' => array('App\Http\Controllers\GLCMasterController@PostEventDetails'),'method' => 'post' ))}}
        ...
        {{--<div class="mwb-form-group">
            ...
            <label for="text" class="mwb-form-text-label">Enter Url</label>
        </div>--}}
            ...
            if (files.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        window.location.href = '/EventSectionIndex';
                    },
